...
//cours_yoga
$app->get('/cours_yoga', 'WF3\Controller\HomeController::homePageCoursYoga')->bind('cours_yoga');

//equipe
$app->match('/equipe', 'WF3\Controller\HomeController::homePageEquipe')->bind('equipe');

//tarifs
$app->get('/tarifs', 'WF3\Controller\HomeController::homePageTarifs')->bind('tarifs');

//partenaires
$app->match('/partenaires', 'WF3\Controller\HomeController::homePagePartenaires')->bind('partenaires');
